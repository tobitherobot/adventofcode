...
{	
	...
	public void testCustom()
	{
		...
		fr = new FileReader("109,-1,4,1,99");
		intcode.setCode(fr.readLongListSplit(","));
		intcode.run();
		Assertions.assertEquals(-1, intcode.getLastOutput());
		
		fr = new FileReader("109,-1,104,1,99");
		intcode.setCode(fr.readLongListSplit(","));
		intcode.run();
		Assertions.assertEquals(1, intcode.getLastOutput());
		
		fr = new FileReader("109,-1,204,1,99");
		intcode.setCode(fr.readLongListSplit(","));
		intcode.run();
		Assertions.assertEquals(109, intcode.getLastOutput());
		
		fr = new FileReader("109,1,9,2,204,-6,99");
		intcode.setCode(fr.readLongListSplit(","));
		intcode.run();
		Assertions.assertEquals(204, intcode.getLastOutput());
		
		fr = new FileReader("109,1,109,9,204,-6,99");
		intcode.setCode(fr.readLongListSplit(","));
		intcode.run();
		Assertions.assertEquals(204, intcode.getLastOutput());
		
		fr = new FileReader("109,1,209,-1,204,-106,99");
		intcode.setCode(fr.readLongListSplit(","));
		intcode.run();
		Assertions.assertEquals(204, intcode.getLastOutput());
		
		fr = new FileReader("109,1,3,3,204,2,99");
		intcode.setCode(fr.readLongListSplit(","));
		intcode.addInput(123456789L);
		intcode.run();
		Assertions.assertEquals(123456789L, intcode.getLastOutput());
		
		fr = new FileReader("109,1,203,2,204,2,99");
		intcode.setCode(fr.readLongListSplit(","));
		intcode.addInput(123456789L);
		intcode.run();
		Assertions.assertEquals(123456789L, intcode.getLastOutput());
